...
public class Panel_ProcedimientoCirugia extends javax.swing.JPanel {
    ...
    public Panel_ProcedimientoCirugia() {
        initComponents();
        PaddingTextField();
    ...
    private void PaddingTextField() {
        ...
        Campo_duracion.setBorder(new EmptyBorder(topPadding, leftPadding, bottomPadding, rightPadding));
        Campo_tarifaReal.setBorder(new EmptyBorder(topPadding, leftPadding, bottomPadding, rightPadding));
        Campo_IPS.setBorder(new EmptyBorder(topPadding, leftPadding, bottomPadding, rightPadding));
        Campo_Dias.setBorder(new EmptyBorder(topPadding, leftPadding, bottomPadding, rightPadding));
    ...
    private void ConsultaDatosResponsablesAsync() {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                ResultSet datos = objCPM.DatosResponsables("Cirujano");
                ...
                while (datos.next()) {
                    ...
                    Combo_responsable.addItem(nombreCompleto);
    ...
    private void initComponents() {
        ...
        DataChoose_FechaRegistro = new com.toedter.calendar.JDateChooser();
        label_TipoUsuario9 = new javax.swing.JLabel();
        Combo_TipoCirugia = new javax.swing.JComboBox<>();
        label_TipoUsuario10 = new javax.swing.JLabel();
        Campo_tarifaReal = new javax.swing.JTextField();
        label_TipoUsuario11 = new javax.swing.JLabel();
        Campo_IPS = new javax.swing.JTextField();
        label_TipoUsuario12 = new javax.swing.JLabel();
        ...
        Label_RestablecerPC = new javax.swing.JLabel();
        ...
        label_Titulo_Cotizantes.setText("PROCEDIMIENTO DE CIRUGÍA");
        ...
        Label_texto_cotizante.setText("En esta sección el encargado podrá ingresar los datos del procedimiento de cirugía que se le realizará a un cotizante o ");
        ...
        Campo_duracion.setBackground(new java.awt.Color(217, 217, 217));
        Campo_duracion.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        Campo_duracion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(217, 217, 217)));
        Campo_duracion.setPreferredSize(new java.awt.Dimension(151, 28));
        ...
        label_TipoUsuario9.setText("Tipo cirugía *");

        Combo_TipoCirugia.setBackground(new java.awt.Color(217, 217, 217));
        Combo_TipoCirugia.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        Combo_TipoCirugia.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "General", "Ortopédica", "Cardiovascular", "Plástica", "Urológcia", "Ginecológica" }));

        label_TipoUsuario10.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        label_TipoUsuario10.setForeground(new java.awt.Color(0, 14, 20));
        label_TipoUsuario10.setText("Tarifa Real *");

        Campo_tarifaReal.setBackground(new java.awt.Color(217, 217, 217));
        Campo_tarifaReal.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        Campo_tarifaReal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(217, 217, 217)));
        Campo_tarifaReal.setPreferredSize(new java.awt.Dimension(151, 28));

        label_TipoUsuario11.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        label_TipoUsuario11.setForeground(new java.awt.Color(0, 14, 20));
        label_TipoUsuario11.setText("Identificación IPS *");

        Campo_IPS.setBackground(new java.awt.Color(217, 217, 217));
        Campo_IPS.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        Campo_IPS.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(217, 217, 217)));
        Campo_IPS.setPreferredSize(new java.awt.Dimension(151, 28));

        label_TipoUsuario12.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        label_TipoUsuario12.setForeground(new java.awt.Color(0, 14, 20));
        label_TipoUsuario12.setText("Días hospitalización *");

        Campo_Dias.setBackground(new java.awt.Color(217, 217, 217));
        Campo_Dias.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        Campo_Dias.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(217, 217, 217)));
        Campo_Dias.setPreferredSize(new java.awt.Dimension(151, 28));

        TextArea_descripcion.setBackground(new java.awt.Color(217, 217, 217));
        TextArea_descripcion.setColumns(20);
        TextArea_descripcion.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        TextArea_descripcion.setLineWrap(true);
        TextArea_descripcion.setRows(5);
        TextArea_descripcion.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Descripción del procedimiento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 0, 11))); // NOI18N
        ...
        label_TipoUsuario13.setText("Seleccione al responsable de la cirugía");

        Combo_responsable.setBackground(new java.awt.Color(217, 217, 217));
        Combo_responsable.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
            ...
            .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                ...
                .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                        ...
                        .addGap(26, 26, 26)
                        .addComponent(DataChoose_FechaRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(label_TipoUsuario9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(Combo_TipoCirugia, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                        .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, Panel_IngresoUsuario1Layout.createSequentialGroup()
                                    .addComponent(label_TipoUsuario11, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(Campo_IPS, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, Panel_IngresoUsuario1Layout.createSequentialGroup()
                                    .addComponent(label_TipoUsuario8, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(Campo_duracion, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                                ...
                                .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                                            .addComponent(label_TipoUsuario10)
                                            .addGap(15, 15, 15)
                                            .addComponent(Campo_tarifaReal, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                                            .addComponent(label_TipoUsuario12)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                            .addComponent(Campo_Dias, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addComponent(Combo_responsable, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                                .addGap(37, 37, 37)
        ...
        Panel_IngresoUsuario1Layout.setVerticalGroup(
            ...
            .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(label_TipoUsuario9, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                    .addComponent(DataChoose_FechaRegistro, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(label_TipoUsuario7, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                    .addComponent(Combo_TipoCirugia))
                .addGap(18, 18, 18)
                .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(label_TipoUsuario10, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(Campo_tarifaReal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(label_TipoUsuario8)
                        .addComponent(Campo_duracion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(label_TipoUsuario11, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Campo_IPS, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(label_TipoUsuario12, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(Panel_IngresoUsuario1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Panel_IngresoUsuario1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Combo_responsable, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        Label_RestablecerPC.setFont(new java.awt.Font("Calibri", 1, 15)); // NOI18N
        Label_RestablecerPC.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Label_RestablecerPC.setText("Restablecer");
        Label_RestablecerPC.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Label_RestablecerPC.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                Label_RestablecerPCMousePressed(evt);
            }
        });
        ...
        Panel_botonRestablecer1Layout.setHorizontalGroup(
            ...
            .addComponent(Label_RestablecerPC, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
        );
        Panel_botonRestablecer1Layout.setVerticalGroup(
            Panel_botonRestablecer1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Label_RestablecerPC, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
        );
    ...
    private void Label_GuardarDatosPCMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Label_GuardarDatosPCMousePressed
        ...
        if (id_usuario == 0) {
            ...
            String fechaFormato = formatoFecha.format(DataChoose_FechaRegistro.getDate());
            LocalDate fechaRegistroProcedimiento = LocalDate.parse(fechaFormato);

            String tipoCirugia = Combo_TipoCirugia.getSelectedItem().toString();
            int duracionProcedimiento = Integer.parseInt(Campo_duracion.getText());
            double tarifaReal = Double.parseDouble(Campo_tarifaReal.getText());
            String tipoProcedimiento = "P. cirugía";

            int codigoIPS = Integer.parseInt(Campo_IPS.getText());
            int diasHosp = Integer.parseInt(Campo_Dias.getText());
            ...
            ProcedimientoCirugia objPC = new ProcedimientoCirugia(codigoCirujano, codigoIPS, diasHosp, tipoCirugia, descripcion, fechaRegistroProcedimiento, duracionProcedimiento, tarifaReal);

            Double costoPago = objPC.CalcularCostoPago();
            ...
            boolean resultadoguardado = objCPM.InsertarDatosProcedimientoCirugia(objPC, tipoProcedimiento, costoPago, id_usuario);
    ...
    private void Label_RestablecerPCMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Label_RestablecerPCMousePressed

        Campo_duracion.setText("");
        Campo_IPS.setText("");
        Campo_tarifaReal.setText("");
        Campo_Dias.setText("");
        TextArea_descripcion.setText("");
        label_valorCancelar.setText("$ 0");

    }//GEN-LAST:event_Label_RestablecerPCMousePressed
    ...
    private javax.swing.JTextField Campo_IPS;
    ...
    private javax.swing.JTextField Campo_tarifaReal;
    private javax.swing.JTextField Campo_telefono;
    private javax.swing.JComboBox<String> Combo_TipoCirugia;
    private javax.swing.JComboBox<String> Combo_responsable;
    private javax.swing.JComboBox<String> Combo_tipoUsuario;
    private com.toedter.calendar.JDateChooser DataChoose_FechaRegistro;
    ...
    private javax.swing.JLabel Label_RestablecerPC;
    ...
    private javax.swing.JLabel label_TipoUsuario10;
    private javax.swing.JLabel label_TipoUsuario11;
    private javax.swing.JLabel label_TipoUsuario12;
